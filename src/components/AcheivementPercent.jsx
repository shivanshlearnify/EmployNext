...
const AcheivementPercent = () => {
  return (
    <div className="flex justify-evenly mt-8 sm:flex-col sm:items-center md:gap-2">
      <div className="max-w-64 flex flex-col gap-2 sm:text-center">
      ...
      <hr className="bg-gray-300 w-[1px] h-[130px] sm:hidden" />
      <div className="max-w-64 flex flex-col gap-2 sm:text-center">
